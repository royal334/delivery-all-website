...
function Header() {
  ...
  return (
    <header className='sticky top-0 bg-white z-50'>
      <div className=' container mx-auto  p-4 my-2 flex items-center justify-between flex-wrap md:flex-nowrap'>
        ...
        <nav className='w-full hidden md:flex md:justify-between '>
          <ul className=' flex justify-center items-center space-x-4 ml-auto'>
            <li><Link href='/' className={`${activeLink ==='home' ? 'text-bright-green' : null} font-bold font-inter`} onClick={() => handleLinkClick('home')}>Home</Link></li>
            <li><Link href='/about'  className={`${activeLink ==='about' ? 'text-bright-green' : null} font-bold font-inter`} onClick={() => handleLinkClick('about')}>About</Link></li>
            <li><Link href='/tracking'  className={`${activeLink ==='tracking' ? 'text-bright-green' : null} font-bold font-inter`} onClick={() => handleLinkClick('tracking')}>Tracking</Link></li>
            <li><Link href='/contact'  className={`${activeLink ==='contact' ? 'text-bright-green' : null} font-bold font-inter`} onClick={() => handleLinkClick('contact')}>Contact</Link></li>
          </ul>
