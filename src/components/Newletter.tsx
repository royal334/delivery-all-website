...
const Newletter = () => {
  return (
    <div
    className="h-[340px] bg-no-repeat bg-cover bg-center py-[50px] px-6 lg:px-0 "
    style={{backgroundImage: "linear-gradient(0deg, #000000CC, #000000CC), url('/bg-newsletter.jpg')",}}>
        <div className="flex flex-col items-center justify-center lg:max-w-md mx-auto">
            <p className='text-bright-green font-bold text-sm font-inter '>Discover More</p>
            <p className='text-xl font-inter font-bold text-white pt-4'>Subscribe To Our Newsletter</p>
            ...
            <div className="mt-4 relative w-full ">
               ...
               <button className='text-white capitalize font-inter text-sm font-semibold  bg-bluish-green rounded-md py-[14px] px-8 w-full mr-3 '>
               Subscribe</button>
               </div>
            </div>
        </div>
